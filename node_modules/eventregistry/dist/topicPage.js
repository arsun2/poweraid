...
var TopicPage = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.eventRegistry.jsonRequest("/json/topicPage", params)];
                    case 1:
                        _a.concept = _b.sent();
     ...
     */
    TopicPage.prototype.addConcept = function (conceptUri, weight) {
        if (!_.isNumber(weight)) {
            throw new Error("Weight value has to be a positive or negative number");
        }
        this.topicPage.concepts = __spread(this.topicPage.concepts, [{ uri: conceptUri, wgt: weight }]);
    };
    /**
    ...
    TopicPage.prototype.getArticles = function (args) {
        if (args === void 0) { args = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, page, _b, count, _c, sortBy, _d, sortByAsc, _e, returnInfo, params, request;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        _a = args.page, page = _a === void 0 ? 1 : _a, _b = args.count, count = _b === void 0 ? 100 : _b, _c = args.sortBy, sortBy = _c === void 0 ? "rel" : _c, _d = args.sortByAsc, sortByAsc = _d === void 0 ? false : _d, _e = args.returnInfo, returnInfo = _e === void 0 ? new returnInfo_1.ReturnInfo() : _e;
                        if (page < 1) {
                        ...
                        return [4 /*yield*/, this.eventRegistry.jsonRequest("/json/article", params)];
                    case 1:
                        request = _f.sent();
    ...
    TopicPage.prototype.getEvents = function (args) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        _a = args.page, page = _a === void 0 ? 1 : _a, _b = args.count, count = _b === void 0 ? 50 : _b, _c = args.sortBy, sortBy = _c === void 0 ? "rel" : _c, _d = args.sortByAsc, sortByAsc = _d === void 0 ? false : _d, _e = args.returnInfo, returnInfo = _e === void 0 ? new returnInfo_1.ReturnInfo() : _e;
                        if (page < 1) {
                            throw new RangeError("page has to be >= 1");
                        }
                        if (count > 50) {
                        ...
                        return [4 /*yield*/, this.eventRegistry.jsonRequest("/json/event", params)];
                    case 1:
                        request = _f.sent();
