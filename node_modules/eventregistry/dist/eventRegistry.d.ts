...
export declare class EventRegistry {
    ...
    jsonRequestAnalytics(path: string, parameters?: any): Promise<AxiosResponse>;
    /**
     ...
     * @param args Object which contains a host of optional parameters
     */
    suggestCustomConcepts(prefix: string, args?: EventRegistryStatic.SuggestCustomConceptsArguments): Promise<any>;
    /**
