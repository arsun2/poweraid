...
var EventRegistry = /** @class */ (function () {
    ...
    EventRegistry.prototype.jsonRequestAnalytics = function (path, parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var request, errorMessage, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.jsonRequest("/json/suggestConceptsFast", params)];
                    case 1:
                        request = _g.sent();
                        return [2 /*return*/, request.data];
                }
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        params = _.extend({}, params, otherParams, returnInfo.getParams());
                        return [4 /*yield*/, this.jsonRequest("/json/suggestCategoriesFast", params)];
                    case 1:
                        request = _d.sent();
                        return [2 /*return*/, request.data];
                }
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.jsonRequest("/json/suggestSourcesFast", __assign({ prefix: prefix, page: page, dataType: dataType, count: count }, otherParams))];
                    case 1:
                        request = _d.sent();
                        return [2 /*return*/, request.data];
                }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.jsonRequest("/json/suggestSourceGroups", __assign({ prefix: prefix, page: page, count: count }, otherParams))];
                    case 1:
                        request = _c.sent();
                        return [2 /*return*/, request.data];
                }
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.jsonRequest("/json/suggestLocationsFast", params)];
                    case 1:
                        request = _f.sent();
                        return [2 /*return*/, request.data];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.jsonRequest("/json/suggestSourcesFast", params)];
                    case 1:
                        request = _a.sent();
                        return [2 /*return*/, request.data];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.jsonRequest("/json/suggestAuthorsFast", params)];
                    case 1:
                        request = _a.sent();
                        return [2 /*return*/, request.data];
                }
    ...
    EventRegistry.prototype.suggestCustomConcepts = function (prefix, args) {
        if (args === void 0) { args = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, lang, _b, conceptLang, _c, page, _d, count, _e, returnInfo, otherParams, params, request;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        _a = args.lang, lang = _a === void 0 ? "eng" : _a, _b = args.conceptLang, conceptLang = _b === void 0 ? "eng" : _b, _c = args.page, page = _c === void 0 ? 1 : _c, _d = args.count, count = _d === void 0 ? 20 : _d, _e = args.returnInfo, returnInfo = _e === void 0 ? new returnInfo_1.ReturnInfo() : _e, otherParams = __rest(args, ["lang", "conceptLang", "page", "count", "returnInfo"]);
                        if (page < 1) {
                            throw new Error("page parameter should be above 0");
                        }
