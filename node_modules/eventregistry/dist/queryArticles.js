...
var QueryArticlesIter = /** @class */ (function (_super) {
    ...
    QueryArticlesIter.initWithComplexQuery = function (er, complexQuery, args) {
        if (args === void 0) { args = {}; }
        var _a = args.dataType, dataType = _a === void 0 ? "news" : _a, params = __rest(args, ["dataType"]);
        var query = new QueryArticlesIter(er, __assign({ dataType: dataType }, params));
        if (complexQuery instanceof query_1.ComplexArticleQuery) {
            query.setVal("query", JSON.stringify(complexQuery.getQuery()));
        }
        else if (_.isString(complexQuery)) {
...
var RequestArticlesInfo = /** @class */ (function (_super) {
    ...
    function RequestArticlesInfo(_a) {
        if (_a === void 0) { _a = {}; }
        var _b = _a.page, page = _b === void 0 ? 1 : _b, _c = _a.count, count = _c === void 0 ? 200 : _c, _d = _a.sortBy, sortBy = _d === void 0 ? "date" : _d, _e = _a.sortByAsc, sortByAsc = _e === void 0 ? false : _e, _f = _a.returnInfo, returnInfo = _f === void 0 ? new returnInfo_1.ReturnInfo() : _f, unsupported = __rest(_a, ["page", "count", "sortBy", "sortByAsc", "returnInfo"]);
        var _this = _super.call(this) || this;
...
var RequestArticlesRecentActivity = /** @class */ (function (_super) {
    ...
    function RequestArticlesRecentActivity(_a) {
        if (_a === void 0) { _a = {}; }
        var _b = _a.maxArticleCount, maxArticleCount = _b === void 0 ? 100 : _b, _c = _a.updatesAfterTm, updatesAfterTm = _c === void 0 ? undefined : _c, _d = _a.updatesAfterMinsAgo, updatesAfterMinsAgo = _d === void 0 ? undefined : _d, _e = _a.updatesUntilTm, updatesUntilTm = _e === void 0 ? undefined : _e, _f = _a.updatesUntilMinsAgo, updatesUntilMinsAgo = _f === void 0 ? undefined : _f, _g = _a.mandatorySourceLocation, mandatorySourceLocation = _g === void 0 ? false : _g, _h = _a.returnInfo, returnInfo = _h === void 0 ? new returnInfo_1.ReturnInfo() : _h, unsupported = __rest(_a, ["maxArticleCount", "updatesAfterTm", "updatesAfterMinsAgo", "updatesUntilTm", "updatesUntilMinsAgo", "mandatorySourceLocation", "returnInfo"]);
        var _this = _super.call(this) || this;
