...
var RequestEventSimilarEvents = /** @class */ (function (_super) {
    ...
    function RequestEventSimilarEvents(args) {
        ...
        addArticleTrendInfo = _c === void 0 ? false : _c, _d = args.aggrHours, aggrHours = _d === void 0 ? 6 : _d, _e = args.includeSelf, includeSelf = _e === void 0 ? false : _e, _f = args.returnInfo, returnInfo = _f === void 0 ? new returnInfo_1.ReturnInfo() : _f, unsupported = __rest(args, ["conceptInfoList", "count", "maxDayDiff", "addArticleTrendInfo", "aggrHours", "includeSelf", "returnInfo"]);
        if (!_.isEmpty(unsupported)) {
...
var RequestEventSimilarStories = /** @class */ (function (_super) {
    ...
    function RequestEventSimilarStories(args) {
        ...
        returnInfo = _d === void 0 ? new returnInfo_1.ReturnInfo() : _d, unsupported = __rest(args, ["conceptInfoList", "count", "lang", "maxDayDiff", "returnInfo"]);
        if (!_.isEmpty(unsupported)) {
