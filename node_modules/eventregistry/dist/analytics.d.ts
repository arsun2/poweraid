...
export declare class Analytics {
     ...
     */
    sentiment(text: string, method?: string): Promise<any>;
     ...
     */
    extractArticleInfo(url: string, proxyUrl?: string): Promise<any>;
    /**
     ...
     */
    trainTopicFinishTraining(uri: string, args?: EventRegistryStatic.Analytics.TrainTopicFinishTrainingArguments): Promise<any>;
    /**
     * Retrieve topic for the topic for which you have already finished training
     * @param uri uri of the topic (obtained by calling trainTopicCreateTopic method)
     * @returns returns the trained topic: { concepts: [], categories: [] }
     */
    trainTopicGetTrainedTopic(uri: string): Promise<any>;
}
