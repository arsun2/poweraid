...
var RequestStorySimilarStories = /** @class */ (function (_super) {
    ...
    function RequestStorySimilarStories(_a) {
        if (_a === void 0) { _a = {}; }
        var _b = _a.count, count = _b === void 0 ? 50 : _b, _c = _a.source, source = _c === void 0 ? "concept" : _c, _d = _a.maxDayDiff, maxDayDiff = _d === void 0 ? Number.MAX_SAFE_INTEGER : _d, _e = _a.addArticleTrendInfo, addArticleTrendInfo = _e === void 0 ? false : _e, _f = _a.returnInfo, returnInfo = _f === void 0 ? new returnInfo_1.ReturnInfo({ articleInfo: new returnInfo_1.ArticleInfoFlags({ bodyLen: 0 }) }) : _f, unsupported = __rest(_a, ["count", "source", "maxDayDiff", "addArticleTrendInfo", "returnInfo"]);
        var _this = _super.call(this) || this;
