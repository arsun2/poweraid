...
var Analytics = /** @class */ (function () {
     ...
     */
    Analytics.prototype.sentiment = function (text, method) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = (_a = _).get;
                        return [4 /*yield*/, this.er.jsonRequestAnalytics("/api/v1/" + (method === "vocabulary" ? "sentiment" : "sentimentRNN"), { text: text })];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent(), "data"])];
                }
            });
        });
     ...
     */
    Analytics.prototype.extractArticleInfo = function (url, proxyUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var params, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = (_a = _).get;
                        return [4 /*yield*/, this.er.jsonRequestAnalytics("/api/v1/extractArticleInfo", params)];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent(), "data"])];
                }
            });
        });
    ...
    Analytics.prototype.trainTopicOnTweets = function (twitterQuery, args) {
        if (args === void 0) { args = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, useTweetText, _b, maxConcepts, _c, maxCategories, _d, maxTweets, _e, notifyEmailAddress, params, _f, _g;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        _a = args.useTweetText, useTweetText = _a === void 0 ? true : _a, _b = args.maxConcepts, maxConcepts = _b === void 0 ? 20 : _b, _c = args.maxCategories, maxCategories = _c === void 0 ? 10 : _c, _d = args.maxTweets, maxTweets = _d === void 0 ? 2000 : _d, _e = args.notifyEmailAddress, notifyEmailAddress = _e === void 0 ? undefined : _e;
                        if (maxTweets > 5000) {
                            throw new Error("We can analyze at most 5000 tweets");
                        }
                        params = { twitterQuery: twitterQuery, useTweetText: useTweetText, maxConcepts: maxConcepts, maxCategories: maxCategories, maxTweets: maxTweets };
                    ...
                    case 1: return [2 /*return*/, _g.apply(_f, [_h.sent(), "data"])];
                }
            });
        });
    };
     ...
     */
    Analytics.prototype.trainTopicFinishTraining = function (uri, args) {
        if (args === void 0) { args = {}; }
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @returns returns the trained topic: { concepts: [], categories: [] }
     */
    Analytics.prototype.trainTopicGetTrainedTopic = function (uri) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = _).get;
                        return [4 /*yield*/, this.er.jsonRequestAnalytics("/api/v1/trainTopic", { action: "getTrainedTopic", uri: uri })];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent(), "data"])];
                }
            });
        });
